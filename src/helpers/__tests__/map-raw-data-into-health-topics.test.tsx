...
describe("#mapRawDataIntoHealthTopic", () => {
	it("returns an array", function () {
		expect(Array.isArray(mapRawDataIntoHealthTopic(mockDataForHealthTopics))).toEqual(true);
	});

	it("returns an array of objects with: id, title, categories, image (an object with imageUrland, imageAlt), relatedItem (an object with id, title and url), sections(an object with id, title and content)", () => {
