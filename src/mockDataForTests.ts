    export const mockDataForSuggestions = {
      ...
      export const mockDataForHealthTopics = {
        Result: {
          Error: "False",
          Total: 2,
          Query: {
