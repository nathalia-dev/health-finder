...
describe("<HealthTopicList />", () => {
	...
	const healthTopics = [
		{ title: title1, categories: categories1, id, image, relatedItem, sections },
		{ title: title2, categories: categories2, id: id2, image, relatedItem, sections },
	];

	it("should display the two healthTopic cards", () => {
